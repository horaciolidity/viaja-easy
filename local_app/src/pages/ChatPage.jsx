    ...
    return (
      <div className="flex flex-col h-screen w-screen items-center justify-center bg-slate-900 p-4">
        <p className="text-slate-400 text-center mb-4">
          No se pudo cargar la información del chat. Es posible que el viaje ya no esté activo.
        </p>
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex flex-col font-sans">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://horizons-cdn.hostinger.com/b39e7321-a8b2-479d-ac5b-e21b810ac4d9/d88fcd2a45323bd779384608092b7af0.png')",
          opacity: '0.05',
          backgroundSize: 'min(80vw, 400px)',
        }}
      />
      ...
      >
        <Button
          ...
          size="icon"
          onClick={() => navigate(-1)}
          className="rounded-full text-slate-300 hover:bg-slate-700"
        >
            ...
            >
              ...
              <p
                className={`text-xs mt-1.5 text-right ${
                  msg.sender_id === user.id ? 'text-blue-200/80' : 'text-slate-400'
                }`}
              >
