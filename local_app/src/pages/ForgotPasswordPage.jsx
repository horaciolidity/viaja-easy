...
const ForgotPasswordPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const defaultMessage = "No se pudo enviar el correo. Verificá el email e intentalo de nuevo.";
      const errorMessage = error.message.includes('No se encontró un usuario') 
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Solicita un código para restablecer tu contraseña de ViajaFácil." />
      </Helmet>
      <div className="min-h-screen bg-slate-100 text-gray-800 flex flex-col">
        ...
        >
          <div className="w-full max-w-md text-center">
            ...
            <p className="text-gray-600 mb-8">No te preocupes. Ingresá tu email y te mandamos un código para que la recuperes.</p>
            ...
            <p className="text-sm text-gray-600 mt-6">
                ¿Recordaste tu contraseña? <Link to="/login" className="font-semibold text-blue-600 hover:underline">Volver a iniciar sesión</Link>
            </p>
          </div>
        </motion.div>
      </div>
