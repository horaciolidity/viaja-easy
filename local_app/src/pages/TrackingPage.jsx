...
import React, { useEffect, useMemo, useState, useCallback } from 'react';
    ...
    import PassengerTracking from '@/components/tracking/PassengerTracking';
    ...
    const RideTracking = () => {
      ...
      const driverDestination = useMemo(() => {
        ...
        const nextStop = currentRide.stops?.find(s => !s.completed_at);
        if(nextStop) {
      ...
      return (
        <div className="h-screen w-screen bg-slate-800 relative overflow-hidden">
          <AnimatePresence>
            ...
            >
              {isDriver ? (
                ...
                <PassengerTracking rideId={rideId} />
              )}
            </motion.div>
          </AnimatePresence>
          ...
          <motion.div
            ...
            className="absolute top-5 left-5 z-50 flex gap-2"
          >
            <Button
